...
class author_tang
{
    ...
    public function run()
    {
        ...
        $sqlFileName = "/sql/authors.tang-%s.sql";
        ...
        //唐诗json文件的路径
        $tangFilePathList = glob("{$sourceFilePath}authors.tang.json");
...
//                var_dump($value);
                ...
                $time = time();
                $content .= "(\"{$value['name']}\",\"{$value['desc']}\",\"T\",{$time})";
            }
